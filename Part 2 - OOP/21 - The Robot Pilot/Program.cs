...
int manticorePosition = random.Next(101); // Picks a random int from 0 to 100.
Console.WriteLine("Player, it is your turn to guess how far away from the city the Manticore is.");
